...
export const NotFoundProduct: React.FC<{ isEmpty: boolean, clearFilters: ()=>void}> = ({isEmpty, clearFilters}) => {
    if(!isEmpty)
        return
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center px-4 sm:px-6 lg:px-8">
            <div className="text-center">
                <h1 className="hidden text-9xl font-extrabold text-gray-900 tracking-widest">
                    404
                </h1>
